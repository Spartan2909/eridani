...
use eridani_common::{internal_error, natives::NativeFunction, value::Value};
...
impl PartialEq for Function {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (Function::Rust(fun1), Function::Rust(fun2)) => fun1 == fun2,
...
impl Ord for Function {
    fn cmp(&self, other: &Self) -> Ordering {
        match (self, other) {
            ...
            (Function::Rust(fun1), Function::Rust(fun2)) => fun1.cmp(fun2),
...
impl Binding {
    fn name(&self) -> String {
        match self {
            Binding::Function(f) => f.borrow().name().to_owned(),
            Binding::Module(m) => m.borrow().name().to_owned(),
